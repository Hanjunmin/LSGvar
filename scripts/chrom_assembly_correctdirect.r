...
print(all)
write.table(all[all$V5 > all$V6,]$V1, file = paste(dirname(args[4]),"/minus.txt",sep=""), sep = "\t", row.names = FALSE, col.names = FALSE,quote=FALSE)
write.table(all[all$V5 <= all$V6,]$V1, file = paste(dirname(args[4]),"/plus.txt",sep=""), sep = "\t", row.names = FALSE, col.names = FALSE,quote=FALSE)
